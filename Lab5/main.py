...
#
#  pyDOE2 - це оновлення пакета pyDOE, який призначений для допомогти вченому, інженеру, статистику тощо для побудови відповідних експериментальних конструкцій
# . Цей модуль створений для вирішення помилок та проблем, які залишились невирішеними в оригінальній упаковці.
#
